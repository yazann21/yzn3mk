 ...
 */
export const validateUsername = (username, minimumLength) => {
 ...
 */
export const validatePlayer = (player, minimumUsernameLength) => validateUUID(player) || validateUsername(player, minimumUsernameLength);
export const validateArray = (array, validatorFunction, ...params) => {
